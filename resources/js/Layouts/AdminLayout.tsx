        ...
        <div className="space-y-8">
            {navSections.map((section) => (
                <div key={section.label}>
                    <p className="px-4 text-[10px] font-bold uppercase tracking-widest text-slate-500 mb-3">
                        {section.label}
                    </p>
                ...
                <div className="lg:hidden sticky top-0 z-40 border-b border-white/5 bg-slate-950/80 px-4 py-4 backdrop-blur-md">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="font-semibold text-white tracking-tight">{pageTitle}</span>
                        </div>
                    ...
                    >
                        <div className="flex h-full flex-col gap-6 lg:sticky lg:top-8 lg:h-[calc(100vh-4rem)]">
                            ...
                            <div className="flex items-center gap-3 px-4 lg:px-0">
                                ...
                                <div>
                                    <h1 className="text-lg font-bold text-white leading-none">{__('admin.brand')}</h1>
                            ...
                            {/* Nav */}
                            <nav className="flex-1 overflow-y-auto pr-2 custom-scrollbar">{renderNav()}</nav>
                                ...
                                >
                                    ...
                                    <div className="relative flex items-center justify-between">
                                        <div>
                                            ...
                                            <p className="text-[10px] text-indigo-200 mt-0.5">{__('admin.pulse.subtitle')}</p>
                                        </div>
