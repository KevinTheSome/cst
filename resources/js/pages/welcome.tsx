  ...
  return (
    <>
      ...
      <div className="bg-[#f4f4f2]">
        <section className="mx-auto flex w-full max-w-6xl flex-col gap-10 px-4 pb-16 pt-12 sm:px-10">
          {/* SLIDESHOW — full width, no side lines, big rounded corners */}
          <div className="relative w-full overflow-hidden rounded-[64px] sm:rounded-[88px] lg:rounded-[120px] shadow-lg shadow-black/15">
            {/* keep ~10% shorter than the original tall version */}
            <div className="relative w-full h-[67.5vh] sm:h-[72vh] lg:h-[76.5vh] max-h-[882px]">
          ...
          <div className="mx-auto flex max-w-3xl flex-col items-center gap-6 px-8 py-10 text-center">
            <h1 className="text-3xl font-semibold text-[#1f2a33] sm:text-4xl">
              Rīgas Tehniskās universitātes,  Mašīnzinību, transporta un aeronautikas fakultātes,
              Biomedicīnas inženierzinātņu un nanotehnoloģiju institūta, Biočipu zinātniskā laboratorija.
            </h1>
            ...
            <p className="text-base leading-relaxed text-[#3a4955] sm:text-lg">
              – studentus un jaunos pētniekus ar pētniecisko praksi.
            </p>
            <Link
              className="rounded-full bg-[#1f675b] px-6 py-3 text-sm font-semibold uppercase tracking-[0.25em] text-white transition hover:bg-[#184f46]"
              href="/test"
            >
              Uzzināt vairāk
            </Link>
          ...
          <div className="flex flex-col gap-8 p-8 md:flex-row md:items-center">
            ...
            <div className="flex flex-col gap-4 text-[#26323b]">
              ...
              <p className="text-base leading-relaxed text-[#40515d]">
                ir laboratorijas vadītājs un vadošais pētnieks, kurš pēta novecošanos un tā ārstēšanas iespējas uz šūnu kultūrām biočipos.
              </p>
              <p className="text-sm uppercase tracking-[0.28em] text-[#74838f]">Mēs radām nākotnes tehnoloģijas</p>
            </div>
          </div>
