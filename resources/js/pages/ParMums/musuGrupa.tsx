...
const Icons = {
    ...
    Code: ({ className }: { className?: string }) => (
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M17.25 6.75L22.5 12l-5.25 5.25m-10.5 0L1.5 12l5.25-5.25m7.5-3l-4.5 16.5" /></svg>
    )
};
                        ...
                        <div className="rounded-3xl border border-slate-200 bg-white/60 backdrop-blur p-8 lg:p-10">
                            <div className="flex flex-col lg:flex-row items-center gap-10">
                                ...
                                <div className="flex-1 text-center lg:text-left">
                                    <h2 className="text-2xl font-bold text-slate-900 mb-2">Digitālā Attīstība</h2>
                                    <h3 className="text-emerald-700 font-medium mb-4">Sadarbība ar VTDT</h3>
                                    ...
                                    >
                                        {showVtdtStudents ? 'Aizvērt komandu' : 'Skatīt izstrādes komandu'}
                            ...
                            {/* DROPDOWN GRID */}
                            {showVtdtStudents && (
                                <div className="mt-12 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 animate-fade-in">
