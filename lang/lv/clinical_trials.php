...
return [
    ...
    'challenges' => [
        'title' => 'Izaicinājumi un nākotnes virzieni',
        'summary' => 'MSC terapija ir daudzsološa, bet nepieciešama standartizācija, lielāki pētījumi un regulatīvo prasību izpilde.',
        'points' => [
            'Standartizācija: avots (UC/adipoze/kaulu smadzenes), deva, ievadīšanas maršruts',
            'Nepieciešami lielāki RCT un ilgtermiņa drošības dati',
            'ATMP regulējums: kvalitātes kontrole un reproducējamība',
            'Tendence: MSC-Exo, ģenētiski modificētas MSC',
            'Potenciāls: kombinācija ar biologiem, autoimūnām slimībām (RA, SLE, MS)',
        ],
    ],
];
