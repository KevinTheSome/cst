...
class FormSeeder extends Seeder
{
    ...
    public function run(): void
    {
            ...
            [
                ...
                'results' => [
                    'fields' => [
                        ...
                        [
                            'id' => (string) Str::uuid(),
                            'label' => ['lv' => '3.4.a Ikdienas aktivitātes (darbs, mācības, mājas darbi):', 'en' => '3.4.a Daily activities (work, studies, household):'],
                            'type' => 'radio',
                            'options' => [
                        ...
                        [
                            'id' => (string) Str::uuid(),
                            'label' => ['lv' => '3.4.b Sociālā dzīve (draugi, pasākumi):', 'en' => '3.4.b Social life (friends, events):'],
                            'type' => 'radio',
                            'options' => [
                                'lv' => ['Maz', 'Vidēji', 'Ļoti daudz'],
                                'en' => ['Little', 'Moderate', 'A lot'],
                        ...
                        [
                            'id' => (string) Str::uuid(),
                            'label' => ['lv' => '3.4.c Psihisko pašsajūtu (trauksme, nomāktība):', 'en' => '3.4.c Mental wellbeing (anxiety, low mood):'],
                            'type' => 'radio',
                            'options' => [
                                'lv' => ['Maz', 'Vidēji', 'Ļoti daudz'],
                                'en' => ['Little', 'Moderate', 'A lot'],
        ...
        foreach ($forms as $formData) {
            // Use updateOrCreate by code so re-running won't duplicate
            Form::updateOrCreate(
                ['code' => $formData['code']],
                $formData
            );

            $this->command->info("Seeded form with code: {$formData['code']}");
        }
    }
}
